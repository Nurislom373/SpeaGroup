...
public class PostServiceTest {
    ...
    void createTest() {
        ...
        postService.create(new PostCreateDTO("633d91140843c91e7b648639", "hello guys", "fhdsgfugudgfuydgfdgyufdgfdgfd", List.of("fugduysgfygdsyhfgdsfdsfds", "fudsyfgudsygfydsgfds"), "PUBLIC", List.of("uutgreyertre")));
